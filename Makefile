...
prepare-static-check: FORCE install-golangci-lint install-modernize install-shellcheck
...
install: FORCE build/shoot-grafter
	install -d -m 0755 "$(DESTDIR)$(PREFIX)/bin"
	install -m 0755 build/shoot-grafter "$(DESTDIR)$(PREFIX)/bin/shoot-grafter"
...
__static-check: FORCE run-shellcheck run-golangci-lint run-modernize
...
goimports: FORCE install-goimports
	@printf "\e[1;36m>> goimports -w -local github.com/cloudoperators/shoot-grafter\e[0m\n"
