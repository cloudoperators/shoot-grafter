...
license-headers: FORCE install-addlicense install-reuse
	...
	@reuse lint -j | jq -r '.non_compliant.missing_licensing_info[]' | sed '/\<vendor\>/d' | $(XARGS) reuse annotate -c 'SAP SE or an SAP affiliate company and Greenhouse contributors' -l Apache-2.0 --skip-unrecognised
